...
class HistologyTranscriptomicsDataset(Dataset):
    ...
    def __init__(self, 
        ...
        logger.info(f"Control cell lines: {len(control_cell_lines)}, Drug cell lines: {len(drug_cell_lines)}")
    ...
    def _create_control_treatment_mapping(self):
        ...
        treatment_grouped = self.filtered_drug_metadata.groupby('cell_line')
